...
class Profile(models.Model):
    typeuser =(('Customer','Customer'),('Engineer', 'Engineer'))
    COL=(('dept1','dept1'),('dept2','dept2')) 
    ...
    type_user=models.CharField(max_length=20,default='customer',choices=typeuser)
    CB=(('sub1',"sub1"),('sub2',"sub2"),('sub3',"sub3"),('sub4',"sub4"),('sub5',"sub5"))
    Branch=models.CharField(choices=CB,max_length=29,default='sub1')
    def __str__(self):
...
class Complaint(models.Model):
    ...
    TYPE=(('Tally1',"Tally1"),('Tally2',"Tally2"),('Tally3',"Tally3"),('Tally4',"Tally4"),('Tally5',"Tally5"))
